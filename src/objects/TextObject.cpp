...
TextObject::TextObject(OpenGLResourceLibrary& glResLib, std::shared_ptr<Shader> shaders, int size, Vector<float, 2> pos, Vector<float, 3> dir, GlyphCache& glyphCache)
