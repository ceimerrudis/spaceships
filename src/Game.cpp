...
bool Game::Update()
{
    ...
    //DebugDrawLine(Vector<float, 3>{0,0,0}, Vector<float, 3>{1,0,0},  Identity(), Vector<float, 3>{1,0,0});
    //DebugDrawLine(Vector<float, 3>{0,0,0}, Vector<float, 3>{0,1,0},  Identity(), Vector<float, 3>{0,1,0});
...
void Game::DebugDrawLine(Vector<float, 3> origin, Vector<float, 3> direction, Matrix<float, 4> translation, Vector<float, 3> color)
{
    std::vector<float> v;
...
void Game::DebugDrawCollider(Collider col, Matrix<float, 4> translation, Vector<float, 3> color)
{
    std::vector<float> v;
    ...
    Vector<float, 3> min = (Vector<float, 3>){0,0,0} - halfSize;
    Vector<float, 3> max = (Vector<float, 3>){0,0,0} + halfSize;
...
void Game::DebugDrawPoint(Vector<float, 3> pos, Matrix<float, 4> translation, Vector<float, 3> color)
{
    std::vector<float> v;
    std::vector<unsigned int> i;
